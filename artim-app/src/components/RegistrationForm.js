...
{!registered && (
        ...
        <form onSubmit={handleFormSubmit((data) => onSubmit(data))}>
          ...
          {registered && ( <div className="bg-white block w-full rounded-md py-2 px-3 border border-gray-400 focus:border-teal-100 focus:ring focus:ring-teal-200 drop-shadow-lg"> 
       <Link href="/login" className="text-pink-500 ">
    <span className="font-bold mb-8 hover:text-pink-700"> Please Login! </span>
    </Link>
            </div>)}
      </div>
      </div>
