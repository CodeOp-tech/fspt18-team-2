        ...
        {post.length > 0 ? (
          <>
            <div className="max-h-screen flex items-center justify-center">
              <img className="rounded-lg" src={post[0].Image1} alt={post[0].Title} />
            </div>
            ...
            <div className="mb-20 text-sm text-left text-neutral-600" dangerouslySetInnerHTML={{ __html: post[0].Body }} />
